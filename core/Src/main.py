...
'''
10 110000111110111110100100 110011                                                        
   110000111110111110100100 
   0.56 v
'''
...
class ADC_LTC2499:
    ...
    def __init__(self, i2c, V_ref:float, V_com:float) -> None:
...
if __name__ == '__main__':
    ...
    adc = ADC_LTC2499(i2c, V_ref= 3.244, V_com= 1.62)
    adc.init()
    while True:
        adc.read()